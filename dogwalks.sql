...
((SELECT dog_id FROM Dogs WHERE name = 'Luna'), '2025-06-12 14:00:00', 40, 'Riverwalk Trail', 'completed'),
((SELECT dog_id FROM Dogs WHERE name = 'Charlie'), '2025-06-13 07:30:00', 30, 'Suburban Dog Park', 'cancelled');